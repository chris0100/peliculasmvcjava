    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group">
                <img src="${urlPublic}/images/${pelicula.imagen}" title="Imagen actual de la pelicula" class="img-rounded" width="150" height="200">
            </div>
        </div>
    </div>
...
<%--                    mantener id para pelicula--%>
                    <form:hidden path="id"/>

<%--                    mantener id para detalle--%>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <form:select id="genero" path="genero" class="form-control" items="${listaGeneros}"/>
                </div>
            </div>
        </div>
